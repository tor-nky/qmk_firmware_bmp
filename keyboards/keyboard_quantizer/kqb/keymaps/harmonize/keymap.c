...
#define LAYOUT_DEF(...) {__VA_ARGS__}
#define TICKMS 5
#define KBD KBD_NONE
#include "../../../harmonize/harmonize.h"

enum custom_keycodes {
    CUSTOM_KEYCODE_START = _USERKEY,
};

const key_string_map_t custom_keys_user = {.start_kc    = SAFE_RANGE,
                                           .end_kc      = K_LNX,
                                           .key_strings = "K_IMMODE\0"
                                                          "K_SCLN\0"
                                                          "K_COMM\0"
                                                          "K_DOT\0"
                                                          "K_SLSH\0"
